...
typedef struct _ShareMemoryPrivateForGuest
{
...
}ShareMemoryPrivateForGuest,*PShareMemoryPrivateForGuest;
 ...
 */
/* ----------------------------------------------------------------*/
static void thread_sem_post_get(PShareMemoryForGuest This)
{
	sem_post(This->Private->GetSem);
}
static void thread_sem_post_save(PShareMemoryForGuest This)
{
	sem_post(This->Private->SaveSem);
}
static void thread_sem_wait_get(PShareMemoryForGuest This)
{
	sem_wait(This->Private->GetSem);
}
static void thread_sem_wait_save(PShareMemoryForGuest This)
{
 ...
 */
/* ----------------------------------------------------------------*/
static void process_sem_post_get(PShareMemoryForGuest This)
{
	semaphore_v(This->Private->GetSemId);
	// sem_post(This->Private->GetSem);
}
static void process_sem_post_save(PShareMemoryForGuest This)
{
	semaphore_v(This->Private->SaveSemId);
	// sem_post(This->Private->SaveSem);
}
static void process_sem_wait_get(PShareMemoryForGuest This)
{
	semaphore_p(This->Private->GetSemId);
	// sem_wait(This->Private->GetSem);
}
static void process_sem_wait_save(PShareMemoryForGuest This)
{
...
//----------------------------------------------------------------------------
static void ShareMemory_CloseMemory(PShareMemoryForGuest This)
{
	unsigned int i;
...
// }
//----------------------------------------------------------------------------
static void ShareMemory_Destroy(PShareMemoryForGuest This)
{
	unsigned int i;
	This->Private->Terminate = 1;
...
//----------------------------------------------------------------------------
static unsigned int ShareMemory_WriteCnt(PShareMemoryForGuest This)
{
	return This->Private->WriteCnt;
}
//----------------------------------------------------------------------------
static char * ShareMemory_SaveStart(PShareMemoryForGuest This)
{
...
//----------------------------------------------------------------------------
static void ShareMemory_SaveEnd(PShareMemoryForGuest This,int Size)
{
...
//----------------------------------------------------------------------------
static char * ShareMemory_GetStart(PShareMemoryForGuest This,int *Size)
{
...
//----------------------------------------------------------------------------
static void ShareMemory_GetEnd(PShareMemoryForGuest This)
{
    // printf("%s(),cnt:%d\n",__FUNCTION__,This->Private->WriteCnt);
	if(This->Private) {
...
//	pthread_mutexattr_t mutexattr2;
	...
	PShareMemoryForGuest This = (PShareMemoryForGuest)calloc(sizeof(ShareMemoryForGuest),1);
	if(This == NULL) {
		printf("F:Err: Creat This\n");
		return NULL;
	}

	This->Private = (PShareMemoryPrivateForGuest)calloc(sizeof(ShareMemoryPrivateForGuest),1);
